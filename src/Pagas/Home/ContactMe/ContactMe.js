                ...
                <div className="card bg-base-100 shadow-xl">
                  <div className="card-body">
                    ...
                    <div className="flex">
                      <div>
                        <img
                          className="rounded-full my-3 ring ring-offset-base-100 ring-offse w-12 mx-10"
                          src={admin}
                          alt=""
                        />
                      </div>
                      <div>
                        <h2 className="text-2xl text-primary my-2">Name</h2>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        <h2 className="text-2xl text-primary my-2">Address</h2>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        <h2 className="text-2xl text-primary my-2">Email & Phone</h2>
